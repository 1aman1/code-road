...
int Solution::smallest_island()
{
    for (int r = 0; r < _row; ++r)
    {
        ...
        {
            int thisIslandSize = _explore_land(r, c);
            if (thisIslandSize)
                smallestIslandSize = min(thisIslandSize, smallestIslandSize);
        }
    }

    return smallestIslandSize == 9999 ? 0 : smallestIslandSize;
}
